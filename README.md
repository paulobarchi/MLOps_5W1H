...
* employing best practices (such as design patterns, documentation, high-standard code review).
...
Data Engineers partner up with MLEs pretty well, as the first are more concerned with the ETL (Extract, Transform, Load) and the late focus more on engineering aspects more closely related to ML itself (again, there is always overlap and gray areas).
